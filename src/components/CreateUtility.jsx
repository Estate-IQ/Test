...
function Step2(props) {
  ...
  const [utility, setUtility] = useState("Utility Type");
  ...
  return (
    <div className="form-group">
      <div className="create_est ">
        ...
        <UtilityType selected={utility} setSelected={setUtility} />
        <input
          type="text"
          id="utilityName"
      ...
      <button className="btn btn-success btn-block">Create Utility</button>
    </div>
  );
}
